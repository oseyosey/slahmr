...
from GaROT.phalp.trackers.GAROT_crossview import GAROT_CV ## GAROT Implementation
...
from GaROT.phalp.configs.base import CACHE_DIR
...
## GAROT implementation, needs reworking.
class HMR2_4dhuman(GAROT_CV):
    def __init__(self, cfg, master=False, parent_garot=None):
        # Ensure parameter names match and parameters are passed correctly
        super().__init__(cfg, master=master, parent_garot=parent_garot)  
...
def main(cfg: DictConfig) -> Optional[float]:
    ...
    phalp_tracker = HMR2_4dhuman(cfg, master=True)
